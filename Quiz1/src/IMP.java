...
class IMP implements MouseListener {
	...
	private JMenu getFunctions() {
		...
		// Add problem1 button
		JMenuItem prob1Item = new JMenuItem("Problem 1");
		prob1Item.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent evt) {
				problem1();
			}
		...
		// Add problem2 button
		JMenuItem prob2Item = new JMenuItem("Problem 2");
		prob2Item.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent evt) {
				problem2();
			}
	...
	private void edgeDetection() {
		...
		for (int row = 0; row < height; row++) {
			for (int col = 0; col < width; col++) {
				...
				// Anthing below 50 goes to black, above 50 goes to
				// white
				if (newValue < 50)
					newValue = 0;
				if (newValue >= 50)
